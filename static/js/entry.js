...
async function autoRating() {
    ...
    if (document.getElementById("particular").value) {
        if (document.getElementById("rate").disabled) {
            ...
            rate = rate.split("|")
            rate = rate[1]
            let deduction = 0.18* rate 
            let drate = rate - deduction

            let taxing = 0.18* drate
            console.log("tax is "+ taxing)
            let amountWithTax = drate + taxing
            console.log("amountWithTax is "+ amountWithTax)
            //let differnce = parseFloat(rate) - parseFloat(amountWithTax)
            let differnce = rate - amountWithTax
            console.log("differnce is "+ differnce)
            //let differncePerc = (differnce/rate)
            //console.log("differncePerc is "+ differncePerc)
            //let addition = differnce + rate
            //console.log("adddition is "+ addition)
            rate = drate + differnce
            console.log("rate is after add"+ rate)
...
async function renewRate() {
    ...
    let drate = rate - deduction
            ...
            //let differncePerc = (differnce/rate)
            //console.log("differncePerc is "+ differncePerc)
            //let addition = differncePerc * rate
            //console.log("adddition is "+ addition)
            rate = drate + differnce
            console.log("rate is after add"+ rate)
